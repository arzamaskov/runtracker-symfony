...
<section id="how" class="py-24 bg-slate-50 relative overflow-hidden">
	...
	<div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
		<div class="text-center mb-20">
			...
			<p class="text-lg text-slate-600 max-w-2xl mx-auto">Три шага к осознанным тренировкам.</p>
		</div>

		<div class="relative grid md:grid-cols-3 gap-12">
			<!-- Connecting line for desktop -->
			<div
				class="hidden md:block absolute top-12 left-[16%] right-[16%] h-0.5 bg-gradient-to-r from-slate-200 via-blue-200 to-slate-200 -z-10"
			></div>

			<!-- Step 1 -->
			<div class="relative text-center group">
				<div
					class="w-24 h-24 mx-auto bg-white rounded-full flex items-center justify-center mb-8 shadow-lg shadow-slate-200/50 border-4 border-slate-50 group-hover:border-blue-50 transition-colors duration-300"
				>
					<span class="text-3xl font-bold text-blue-600">1</span>
				</div>
				<h3 class="text-xl font-bold text-slate-900 mb-3">Быстрый старт</h3>
				<p class="text-slate-600 leading-relaxed px-4">
					Регистрация займет меньше минуты. Мы спросим только самое важное, чтобы вы могли сразу
					начать.
				</p>
			</div>
			...
			<div class="relative text-center group">
				...
				<h3 class="text-xl font-bold text-slate-900 mb-3">Вся история в одном месте</h3>
				<p class="text-slate-600 leading-relaxed px-4">
					Подключите Strava или Garmin, чтобы собрать все прошлые пробежки. Или просто добавьте их
					вручную.
				</p>
			</div>
			...
			<div class="relative text-center group">
				...
				<h3 class="text-xl font-bold text-slate-900 mb-3">Умная аналитика</h3>
				<p class="text-slate-600 leading-relaxed px-4">
					Следите за формой, контролируйте нагрузку и получайте персональные советы по
					восстановлению.
				</p>
			</div>
		</div>
